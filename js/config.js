window.MARLETTA_CONFIG = {
  ...
  ui: {
    currency: "лв.",
    heroAutoplayMs: 5000,
    defaultHeroTitle: "Каталог за оградни системи, врати и строителни решения",
    defaultHeroText: "Стабилна продуктова база с управление от Google Sheets, ясни филтри и богати продуктови карти.",
    inquirySubjectPrefix: "Запитване за продукт"
  }
};
